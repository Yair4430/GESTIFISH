...
const FormResponsable = ({ buttonForm, responsable, URI, updateTextButton, onCreate }) => {
    ...
    const sendFormR = async (e) => {
        ...
        try {
            if (buttonForm === 'Actualizar') {
                ...
                refreshList(); // Refrescar la lista después de la actualización
                clearFormR();
               ...
               const respuestaApi =  await axios.post(URI, {
                ...
                if (respuestaApi.status == 201) {
                    ...
                    if (typeof onCreate === 'function') {
                        onCreate(respuestaApi.data.data);
                    }
                    clearFormR();
                }
            }
        } catch (error) {
            console.error('Error al enviar el formulario:', error); // Cambia 'errorresponse' por 'error'
