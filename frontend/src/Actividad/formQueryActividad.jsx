                ...
                <table className="table table-bordered border-info text-center" style={{ border: "3px solid" }}>
                    ...
                    <tbody>
                        {ActividadQuery.map((actividad) => (
                            ...
                            <td className='border-info align-middle' style={{ border: "3px solid" }}>{actividad.Desc_Actividad}</td>
                            ...
                            <td className='border-info align-middle' style={{ border: "3px solid" }}>{actividad.Fas_Produccion}</td>
                                <td>
                                    <button onClick={() => getActividad(actividad.fec_actividad)} value="Actualizar" title="Actualizar" className="btn btn-primary">
