...
const CrudActividad = () => {
    ...
    return (
        <>
            <div style={{ marginLeft: '280px', paddingTop: '50px' }}>
                {/* Ícono para agregar */}
                <a
                    onClick={handleAddClick}
                    style={{ width: '8%', fontSize: '20px', color: 'green', display: 'center', justifyContent: 'center' }}
                >
                    <i className="bi bi-plus-circle" style={{ width: '10px' }}></i>
                </a>
            </div>
