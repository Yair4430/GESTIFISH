                    ...
                    <div className="row mb-3">
                        <div className="col-md-6">
                            <div className="form-group">
                                ...
                                <input className="form-control" type="date" id="Fec_Siembra" value={Fec_Siembra} onChange={(e) => setFec_Cosecha(e.target.value)} required min={getTodayDate()} max={getTodayDate()} />
                            </div>
                        </div>
                        <div className="col-md-6">
                            <div className="form-group">
