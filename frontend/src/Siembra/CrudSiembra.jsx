...
const CrudSiembra = () => {
    ...
    const deleteSiembra = async (Id_Siembra) => {      
        try {
            ...
            Swal.fire('Error', 'No se puede eliminar la Siembra porque pertenece a un registro de otro formulario.', 'error');
        }
    };
    ...
    const exportToExcel = () => {
        const ws = XLSX.utils.json_to_sheet(SiembraList.map((siembra) => ({
            ...
            'Estanque': siembra.estanque.Id_Estanque,
